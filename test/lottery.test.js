...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.zen = await MockBEP20.deployed();
        ...
        await this.zen.transfer(bob, '2000', { from: minter });
        await this.zen.transfer(alice, '2000', { from: minter });
        await this.zen.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.zen.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.zen.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.zen.balanceOf(this.lotteryProxyAddress)).toString(), '418');
